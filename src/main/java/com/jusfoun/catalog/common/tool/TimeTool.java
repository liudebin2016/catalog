...
public class TimeTool {
	...
	public static String toTimeString(long time) {
		TimeTool t = new TimeTool(time);
		int day = t.get(TimeTool.DAY);
		int hour = t.get(TimeTool.HOUR);
		int minute = t.get(TimeTool.MINUTE);
		int second = t.get(TimeTool.SECOND);
     ...
     * @param minute    分钟
     */
    public TimeTool(int hour, int minute) {
     ...
     * @param second    秒
     */
    public TimeTool(int hour, int minute, int second) {
...
//    	System.out.println(time);
     ...
     * @param second    秒
     */
    public TimeTool(int day, int hour, int minute, int second) {
     ...
     * @param time      字符串格式的时间
     */
    public TimeTool(String time, String timeSeparator) {
     ...
     * @return          运算后的时间
     */
    public TimeTool addTime(TimeTool time) {
    	TimeTool result = new TimeTool();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public TimeTool subtractTime(TimeTool time) {
    	TimeTool result = new TimeTool();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TimeTool other = (TimeTool) obj;
