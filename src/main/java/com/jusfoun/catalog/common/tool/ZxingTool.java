...
public class ZxingTool {
	...
	public static void main(String[] args) {
		...
		ZxingTool.encode(contents, width, height, imgPath);
		System.out.println("finished zxing EAN-13 encode.");

		String decodeContent = ZxingTool.decode(imgPath);
		...
		ZxingTool.encode2(contents2, width2, height2, imgPath2);
		System.out.println("finished zxing encode.");

		String decodeContent2 = ZxingTool.decode2(imgPath2);
