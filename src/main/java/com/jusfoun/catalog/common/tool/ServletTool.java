...
public class ServletTool {
	...
	// 静态文件后缀
	private final static String[] staticFiles = StringTool.split(Global.getConfig("web.staticFile"), ",");
...
//		if ((StringTool.startsWith(uri, "/static/") || StringTool.endsWithAny(uri, sfs))
//				&& !StringTool.endsWithAny(uri, ".jsp") && !StringTool.endsWithAny(uri, ".java")){
//			return true;
//		}
		if (StringTool.endsWithAny(uri, staticFiles) && !StringTool.endsWithAny(uri, urlSuffix)
				&& !StringTool.endsWithAny(uri, ".jsp") && !StringTool.endsWithAny(uri, ".java")){
			return true;
		}
		return false;
